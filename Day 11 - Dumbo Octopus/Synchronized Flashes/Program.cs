...
namespace Synchronized_Flashes
{
    class Program
    {
        ...
        {
            string[] rawData = System.IO.File.ReadAllLines(@"C:\Users\lukej\OneDrive\Documents\Personal Projects\AdventOfCode\Synchronized Flashes\Octopus Brightness.txt");
            ...
            int day = 0;
            while (flashes != octopus.GetLength(0) * octopus.GetLength(1))
            {
                day++;
                flashes = 0;
