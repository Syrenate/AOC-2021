...
namespace Squid_Bingo
{
    class Program
    {
        ...
        {
            bool bingo = false;
            string[] rawData = (System.IO.File.ReadAllText(@"C:\Users\lukej\OneDrive\Documents\AOC-2021\AdventOfCode\Squid Bingo\BingBoards.txt").Split("\r\n\r\n"));
            ...
            while (bingo == false)
            {
                ...
                finalDraw = Convert.ToInt32(drawnValue);
            }
