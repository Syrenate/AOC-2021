...
namespace Overlap_With_Diagonals
{
    class Program
    {
        static void Main(string[] args)
        {
            string[] rawData = System.IO.File.ReadAllLines(@"C:\Users\lukej\OneDrive\Documents\AOC-2021\AdventOfCode\Overlap With Diagonals\VentCoords.txt");
